...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            @endif
            {{-- @yield('content') --}}
            <form action="{{ route('pendaki.login.submit') }}" method="post">
                @csrf
                <div class="input-group mb-3">
                    <input type="email" class="form-control @error('email') is-invalid @enderror " placeholder="Email" name="username" value="{{ old('email') }}" required autocomplete="email" autofocus>
            ...
            <div class="callout callout-info mt-3 small">
                <h6>Pendaki</h6>
               	<span>username : rival@gmail.com</span><br>
