    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-purple elevation-4">
            ...
            <a href="{{ route('home') }}" class="brand-link">
                <img src="{{ asset('/img/applogo.png')}}" 
                    class="brand-image " style="opacity: .8">
                <span class="brand-text font-weight-bold"> App V.01</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
                    ...
                    <div class="info">
                            ...
                            @php
                            $namalogin = DB::table('tb_pendaki')
                            ->where('id_pendaki',auth()->guard('pendaki')->id())
                            ->first();
                            @endphp

                            {{ $namalogin->nama_pendaki }} <br>
                            </a>
                    </div>
                </div>

                <!-- Sidebar Menu -->
                @include('user_ui.layouts.partials.sideBarMenu')
                <!-- /.sidebar-menu -->
            </div>
            <!-- /.sidebar -->
        </aside>
