                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 px-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_pos') is-invalid @enderror" name="nama_pos" id="nama_pos" value="{{ old('nama_pos') }}"  placeholder="nama_pos" autofocus>
                                    @error('nama_pos')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('mdpl') is-invalid @enderror" name="mdpl" id="mdpl" value="{{ old('mdpl') }}"  placeholder="mdpl">
                                    @error('mdpl')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
